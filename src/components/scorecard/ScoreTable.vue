...
const corporations = [
  { name: 'Arcadian Communities', value: 0 },
  { name: 'Cheung Shing Mars', value: 0 },
  { name: 'Credicor', value: 0 },
  { name: 'Desertron', value: 0 },
  { name: 'Ecoline', value: 0 },
  { name: 'Ecotec', value: 0 },
  { name: 'Green Power', value: 0 },
  { name: 'Guilde des Voleurs', value: 0 },
  { name: 'Guilde Ouvrière', value: 0 },
  { name: 'Helion', value: 0 },
  { name: 'Interplanetary Cinematics', value: 0 },
  { name: 'Inventrix', value: 0 },
  { name: 'Kuiper Cooperative', value: 0 },
  { name: "Ludophiles d'Asnières et d'ailleurs", value: 0 },
